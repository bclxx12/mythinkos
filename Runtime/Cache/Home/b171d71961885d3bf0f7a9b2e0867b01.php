...
<div id="main-container" class="container">
    ...
    <section>
        ...
        <div class="login-form-inbox">
            <form class="login-form" action="/index.php?s=/Home/User/login/back/http%253A%252F%252Fwww.thinkos.chen%252Findex.php%253Fs%253D%252FWeibo%252FIndex%252Findex.html.html" method="post">
            ...
            $("form").submit(function () {
                ...
                function success(data) {
                    if (data.status) {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo (urldecode(op_t($_REQUEST["back"]))); ?>";
                        }, 1500);
                    } else {
