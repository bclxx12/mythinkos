...
<div id="main-container" class="container">
    ...
    <section>
        <div class="login-text"><strong><h1>欢迎注册<?php echo C('WEB_SITE');?>账号</h1></strong></div>
		...
		<?php if(C(VERIFY_OPEN) == 1 OR C(VERIFY_OPEN) == 2): ?><div class="control-group login-input">
            <div class="controls">
    ...
    <script type="text/javascript">
        ...
        $("form").submit(function () {
            ...
            function success(data) {
                if (data.status) {
                    op_success('注册成功，1.5秒后跳转到登陆页面。', '温馨提示');
                    setTimeout(function () {
