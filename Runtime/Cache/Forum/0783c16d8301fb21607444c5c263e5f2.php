    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-4 col-sm-2">
                <img class="hidden-xs" src="/Public/Forum/images/header-rabbit.png"/>
                <img class="visible-xs" style="width: 100px;padding-top: 32px;"  src="/Public/Forum/images/header-rabbit.png"/>
            </div>
...
<div class="row">
    ...
    <div class="col-md-11 col-xs-10">
        ...
        <p class="pull-right-sm text-muted">
    ...
    <div class="row fourm-posts">
        <div class="col-xs-12">
			<div class="row">
				...
				<div class="col-xs-6">
				    <div class="pull-right" title="" style="margin-right: 20px">排序 &nbsp;
				        <a title="按发布时间排序" href="<?php echo U('forum',array('id'=>$_GET['id'],'order'=>'ctime'));?>"><i  class="glyphicon glyphicon-time"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a
				      title="按回复数排序"       href="<?php echo U('forum',array('id'=>$_GET['id'],'order'=>'reply'));?>"><i  class="glyphicon glyphicon-comment"></i></a></div>
				</div>
			</div>
            <section id="contents">
