...
<link type="text/css" rel="stylesheet" href="/Public/static/oneplus/js/ext/toastr/toastr.min.css"/>
<link href="/Public/static/oneplus/css/oneplus.css" rel="stylesheet"/>
...
<script type="text/javascript" src="/Public/static/oneplus/js/ext/toastr/toastr.min.js"></script>
<script type="text/javascript" src="/Public/static/oneplus/js/ext/slimscroll/jquery.slimscroll.min.js"></script>
<script type="text/javascript" src="/Public/static/jquery.iframe-transport.js"></script>
<!--CNZZ广告管家，可自行更改-->
<script type='text/javascript' src='http://js.adm.cnzz.net/js/abase.js'></script>
<!--CNZZ广告管家，可自行更改end-->
<!-- 自定义js -->
<script type="text/javascript" src="/Public/static/oneplus/js/core.js"></script>
...
<div class="navbar-header">
    ...
    <a class="navbar-logo" href="<?php echo U('Home/Index/index');?>">
        <img src="/Public/Home/images/oneplus/oneplus-logo.png" style="width: 150px;"/>
    </a>
</div>
                ...
                <div class="row" style="padding-top: 10px">
                    <div class="col-xs-12">
                        ...
                        <ul class="nav nav-pills ucenter-tab">
                            ...
                            ><a href="<?php echo U('Weibo/Index/index');?>">全站动态</a></li>
                            <?php if(is_login()): ?><li
                                <?php if(($tab) == "concerned"): ?>class="active"<?php endif; ?>
                                ><a href="<?php echo U('Weibo/Index/myconcerned');?>">我关注的</a></li><?php endif; ?>
                        </ul>
        ...
        <div class="col-xs-12">
            ...
            <div style="padding-left: 16px; width: 92%;float: left">
                ...
                <p>
                    ...
                    <span class="pull-right text-primary weibo-comment-link"  data-weibo-id="<?php echo ($weibo["id"]); ?>">
...
<span class="text-primary weibo-comment-link cpointer" data-weibo-id="<?php echo ($weibo["id"]); ?>">
    <i class="glyphicon glyphicon-comment" style="margin-right: 5px"></i><?php if($weiboCommentTotalCount): echo ($weiboCommentTotalCount); endif; ?>
</span>
                    </span>
                </p>
...
(function(){
    ...
    <script type="text/javascript" src="/Public/static/oneplus/js/ext/atwho/atwho.js"></script>
    <link type="text/css" rel="stylesheet" href="/Public/static/oneplus/js/ext/atwho//atwho.css"/>
    <script src="/Public/Weibo/js/weibo.js"></script>
    <script src="/Public/Weibo/js/insertFace.js"></script>
    <script>
