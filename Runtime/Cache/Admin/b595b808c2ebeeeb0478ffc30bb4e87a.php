...
<head>
    <meta charset="UTF-8">
    <title><?php echo ($meta_title); ?>|ThinkOX管理平台</title>
...
<body>
    ...
    <div id="indexMain" class="index-main">
       ...
       <div class="container-span"><?php echo hook('AdminIndex');?></div>
        ...
        <div class="cont-ft">
            <div class="copyright">
                <div class="fl">感谢使用<a href="http://tox.ourstu.com/" target="_blank">ThinkOX</a>管理平台</div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.copyright').html('<div class="copyright"> ©2014 <a href="http://tox.ourstu.com/" target="_blank">thinkox.com</a> 想天软件</div>');
        $('.sidebar').remove();
    })
</script>
